...
manager.
  ...
  ar-worker --manager mgrhost:8000 --capacity 8 --key path/to/secret --verbose 7
...
the most basic being the C<process> method.

  $client->process('My::Task::Class', $arg_list, sub {
    my $reply = shift;
...
pass code references directly to be evaluated by the workers.
